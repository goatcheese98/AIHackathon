    ...
    return (
        (<div
          ...
          `,
            ...
            <div className={cn("relative z-20 w-full h-full flex flex-col items-center justify-center", className)}>{children}</div>
        </div>)
    );
};
...
export const Highlight = ({
    ...
    return (
        (<motion.span
            ...
            className={cn(
                `relative inline-block pb-1 px-1 rounded-lg bg-gradient-to-r from-blue-200 to-cyan-200 dark:from-blue-600 dark:to-cyan-600`,
                className
            )}>
            {children}
        </motion.span>)
